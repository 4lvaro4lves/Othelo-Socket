...
###
def envia():
    msg = nome+':> '+cxTexto.get("1.0","end-1c")
...
janelaPrincipal.title("Jogo Othello(Reversi) com Sockets - CLIENTE")
...
def enviarMSG():
    ...
    texto = Label(janelaPrincipal, text=resultado).place(x=360, y=180)
    print(resultado)
    envia()
